...
public class SignatureService {
	...
	private NodeKeysService nodeKeysService;
	
	@Autowired
	public SignatureService(NodeKeysService nodeKeysService) {
		this.nodeKeysService = nodeKeysService;
	}
	
	public String signByClient(String textToSign) {
		return sign(textToSign, nodeKeysService.getPrivateAsymetricKey());
	}
	...
	public String signByClient(File file) {
		return sign(file, nodeKeysService.getPrivateAsymetricKey());
	}
	...
	public String signByClient(byte[] dataToSign) {
		return sign(dataToSign, nodeKeysService.getPrivateAsymetricKey());
	}
	...
	public boolean verifySign(String signature, String dataToVerify, String publicKey) {
		if(StringUtils.isNotBlank(signature) 
				&& StringUtils.isNotBlank(dataToVerify) 
